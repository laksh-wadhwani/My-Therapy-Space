    ...
    return(
        <React.Fragment>
            <div className="main-box bg-[#E0F4F5]">
                <div className="sections flex-col gap-4 mt-20">
                ...
                <div className="sections flex-col gap-8">
                    <div className="w-[60%] bg-white rounded-3xl flex flex-col box-border gap-4 pb-4">
                        <h4 className="bg-[#3DD4CA] font-serif text-2xl font-black py-6 px-10 rounded-t-3xl shadow-md">Regular Therapy</h4>
                        <div className="flex justify-between pb-2 px-16 border-b border-[#E7EDED]">
                        ...
                        <div className="w-full flex">
                            <div className="w-[50%] flex flex-col gap-4 px-16 item-start">
                            ...
                            <div className="w-[50%] flex flex-col gap-4 px-16 items-end">
                        ...
                        <p className="font-serif text-sm text-gray-400 italic px-16">Note: Different options for therapy sessions based on the time spent (face-to-face)</p>
                    </div>
