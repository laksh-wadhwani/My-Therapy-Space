        ...
        <React.Fragment>
            <div className="main-box bg-[#E0F4F5] gap-8 items-center">
                ...
                <div className="w-full flex max-sm:flex-col max-sm:gap-6 justify-around px-16 max-sm:px-8">
                    ...
                    <div className="w-[50%] max-sm:w-full flex flex-col max-sm:gap-5 justify-between p-6 border border-gray-300 rounded-xl shadow-xl bg-white">
                ...
                <div className="w-[95%] border border-gray-300 rounded-xl shadow-md flex flex-col gap-2 bg-white">
