    ...
    <React.Fragment>
      ...
      <div className="main-box bg-[#E0F4F5] gap-10">
        ...
        <div id="speech-pathology" className="w-full flex flex-col gap-4 px-8 lg:px-14">
          <h2 className="font-serif text-2xl font-normal capitalize text-black">Speech Pathology</h2>
          ...
          <div className="w-full flex flex-col xl:flex-row gap-4 items-start">
            ...
            <div className="flex flex-col gap-6 w-full xl:w-[50%]">
              <p className="font-serif text-lg uppercase text-black max-sm:text-center">
...
nasogastric or gastrostomy tubes. </p>
        ...
        <div id="occupational-therapy" className="w-full flex flex-col gap-4 px-8 lg:px-14 text-black">
