...
import { ChangeStatus, DeleteBlog, GetAllBlogs, GetPublishedBlogs, GetSpecificBlog, SaveAsDraft, UpdateBlog, UploadBlog } from "../controllers/blogs.controllers.js";
...
router.get("/get-published-blogs", GetPublishedBlogs)
